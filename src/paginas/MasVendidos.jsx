...
export default function Libros() {
  ...
  const librosMasVendidos = libros.filter((libro) => libro.categoria === "MasVendidos" );


  const librosFiltrados = librosMasVendidos.filter(
    (libro) =>
          ...
          <div className="col-12 col-md-6 mx-auto">
            ...
            {busqueda && (
              <small className="text-muted">
                Mostrando {librosFiltrados.length} de {librosMasVendidos.length} Libros
              </small>
            )}
          </div>
        </div>
                      ...
                      <div className="mt-3 pt-3 border-top">
                        <div className="d-flex gap-2">
                          <button
                            ...
                            className="btn btn-success btn-sm w-75 mx-auto"
                          >
                            Editar
                          </button>
                          <button
                            onClick={() => manejarEliminar(libro)}
                            className="btn btn-danger btn-sm w-75 mx-auto"
                          >
                            Eliminar
                          </button>
                        </div>
